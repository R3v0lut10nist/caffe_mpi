 ...
 */
template <typename Dtype>
class HingeLossDetLayer : public LossLayer<Dtype> {
 public:
  explicit HingeLossDetLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "HingeLossDet"; }
